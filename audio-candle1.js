...
//opening scene: church background
...
function draw() {
  ...
  // draw the dark background and calculate the size and position for the stained glass windows
  const cw = width;
  const ch = height;
...
// resize the canvas and redraw the scene when the browser window changes size
